  ...
  <div class="sidebar" data-navbar>
    ...
    <nav class="navbar">
      <ul class="navbar-list">
        ...
        <li class="navbar-item">
            <a href="/upload" class="navbar-link" data-nav-link>What My Perfume?</a>
          </li>
      ...
      <section class="section about" id="about" aria-label="about">
        <div class="container">
          ...
          <p class="section-text">
            Fragrance is an art fused with science. In WANGI, we believe that each product is there to make you adored, loved and remembered.
          </p>
        ...
        <div class="container">
          ...
          <div class="title-wrapper">
            ...
            <ul class="filter-btn-list">
              ...
              <li class="filter-btn-item">
                <button class="filter-btn" data-filter-btn="perfume">Perfume</button>
              </li>
